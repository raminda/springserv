...
import com.millenniumit.mx.data.issueman.dao.IssuemanTicketDao2;
...
import com.millenniumit.mx.data.issueman.service.IssuemanTicketService2;
...
@Service("issuemanTicketService2")
public class IssuemanTicketServiceImpl2 implements IssuemanTicketService2 {
	...
	@Autowired
	@Qualifier("issuemanTicketDao2")
	private IssuemanTicketDao2 issuemanTicketDao;

	/**
	 * @return the issuemanTicketDao
	 */
	public IssuemanTicketDao2 getIssuemanTicketDao() {
	 ...
	 */
	public void setIssuemanTicketDao(IssuemanTicketDao2 issuemanTicketDao) {
